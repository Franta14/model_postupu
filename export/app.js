...
loginOverlay.innerHTML = `
    <div style="text-align: center; padding: 20px;">
        ...
        <button id="google-login-btn" class="tut-allow-interaction" style="background: white; color: black; border: none; padding: 12px 24px; border-radius: 25px; font-weight: bold; font-size: 1.1rem; cursor: pointer; display: flex; align-items: center; gap: 10px; margin: 0 auto; box-shadow: 0 4px 15px rgba(255,255,255,0.2);">
