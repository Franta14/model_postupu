...
// Získání přihlašovací obrazovky z HTML (Unified White Splash & Login Overlay)
...
function renderExploreGrid() {
    ...
    groups.forEach((group, idx) => {
        ...
        // Pomalé, elegantní a plynulé časování (zrychleno): každá dlaždice má lehce odlišnou periodu a fázový posun,
        // aby nepůsobily synchronizovaně a pohyb byl přirozený.
        const baseDur = 45;
        const dur = baseDur + (idx % 4) * 8; // např. 45s, 53s, 61s, 69s
